...
<body>
<div id="we">
		<b><font color="blue">created by: 卢丽莎， 苏少伟；</font>
		<br><font color="green">苏少伟:完成角色列表 分页展示  完成编辑保存 完成批量删除 其它</font>
		<br/><font color="green">卢丽莎: 完成新增功能 完成搜索功能  完成单行删除 </font></br>
 </div>
	<!-- 头部{ -->
			...
			<td width="300" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td align="left"><!-- <a href="javascript:help()"> --><div id ="flip">帮助<div/><!-- </a> --></td>
						<td width="17" align="center"><img src="${basePath}images/nsfw/exit.png"width="14" height="14"/></td>
						<td align="left" valign="middle"><a href="${basePath}login/loginAction_logout.action" target="_top">退出</a></td>
					</tr>
				</table>
			</td>
		</tr>
